...
class DonoUser:
    def __init__(self, bot: Red, dono_bank: "DonoBank", guild_id: int, user_id: int, data: int = 0):
        self.bot = bot
...
class DonoBank:
    def __init__(
        self, bot: Red, manager: "DonationManager", name: str, emoji: str, guild_id: int, data: Dict[int, int] = {}
    ):
        self.bot = bot
